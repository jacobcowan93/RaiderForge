...
export const buriedCityPois: MapPoi[] = [
    ...
    },
    {
        ...
        x: 70,
        y: 55,
        description: 'Retail block rear offices; keyed storerooms with high-tier loot.',
        tags: ['key', 'retail'],
    },
    ...
    },
    {
        ...
        x: 74,
        y: 44,
        description: 'Survey and beacon-style steps commonly ping eastern rooftops.',
        tags: ['quest', 'east'],
    },
    {
    ...
    // ── Loot ─────────────────────────────────────────────────────────────────
    {
        ...
        x: 64,
        y: 35,
        description: 'Open shelving with medical consumables — meds, stims, bandages. No key needed.',
        tags: ['loot', 'medical'],
    },
    {
        ...
        x: 52,
        y: 44,
        description: 'Electronics-heavy loot spawn in the commercial block — components and comms gear.',
        tags: ['loot', 'tech'],
    },
    {
        ...
        x: 47,
        y: 70,
        description: 'Hidden pile in the subway tunnels — high-value items, low foot traffic.',
        tags: ['loot', 'hidden'],
    },
    {
    ...
    // ── Named areas ───────────────────────────────────────────────────────────
    {
        ...
        x: 50,
        y: 50,
        description: 'Open urban plaza at the heart of the map. Dominant sightlines in all directions — contested every raid. Control it or avoid it.',
        tags: ['area', 'central'],
    },
    {
        ...
        x: 63,
        y: 37,
        description: 'Multi-wing medical facility — vertical play, key rooms, and medical loot. Some of the best per-slot value on the map.',
        tags: ['area', 'hospital'],
    },
    {
        ...
        x: 55,
        y: 48,
        description: 'Department store, offices, and retail shops. Dense loot and tight CQB angles. Department store back offices hold key-locked high-tier rooms.',
    ...
    },
    {
        ...
        x: 80,
        y: 65,
        description: 'Open yard with crates and machinery — long sightlines into the yard from elevated catwalks. Quest hand-offs and container loot concentrate here.',
        tags: ['area', 'railyard'],
    },
    {
        ...
        x: 58,
        y: 70,
        description: 'Dense mid-rise housing — close quarters through hallways and stairwells. Quest sweep zones and scattered residential loot.',
    ...
    },
    {
        ...
        x: 47,
        y: 65,
        description: 'Below-street tunnel network connecting major blocks. Shortcuts between distant extracts — but ARC patrols use it too.',
    ...
    },
    {
        ...
        x: 27,
        y: 34,
        description: 'Elevated church and surrounding ruins on the northwest flank. Dominant overwatch positions — frequently contested for its sightlines to downtown.',
    ...
    // ── ARC spawns ────────────────────────────────────────────────────────────
    {
        ...
        x: 50,
        y: 50,
        description: 'Heavy ARC squad circles the central plaza — aggressive engagement range, variable patrol route.',
        tags: ['arc', 'patrol'],
    },
    {
        ...
        x: 65,
        y: 34,
        description: 'Stationary ARC guards at hospital entry points. Clear before attempting keyed wing.',
        tags: ['arc', 'guard'],
    },
    {
        ...
        x: 82,
        y: 60,
        description: 'ARC squad sweeps between crate stacks — flanking through machinery avoids direct contact.',
        tags: ['arc', 'sweep'],
    },
    {
        ...
        x: 48,
        y: 67,
        description: 'ARC units hold tunnel chokepoints below street level. Flashbangs before entry advised.',
    ...
    // ── Interactions ──────────────────────────────────────────────────────────
    {
        ...
        x: 52,
        y: 22,
        description: 'Rooftop zipline connecting the north commercial block to mid-map. Fast repositioning, loud landing.',
    ...
    },
    {
        ...
        x: 78,
        y: 40,
        description: 'Cross-street zipline on the east side — connects hospital-adjacent rooftop to the railyard approach.',
    ...
    },
    {
        ...
        x: 54,
        y: 54,
        description: 'Activated supply drop — broadcasts a loud call signal audible to all players nearby.',
    ...
    },
    {
        ...
        x: 44,
        y: 60,
        description: 'Restores power to the adjacent zone — unlocks doors and activates area mechanics.',
    ...
    },
    {
        ...
        x: 38,
        y: 55,
        description: 'Working elevator in the parking garage — vertical shortcut between levels but loud and predictable.',
    ...
    // ── Noise hazards ─────────────────────────────────────────────────────────
    {
        ...
        x: 61,
        y: 37,
        description: 'Security scanners at hospital entrance — trigger an audible alarm when passed with weapons drawn. Alert nearby ARC.',
    ...
    },
    {
        ...
        x: 68,
        y: 50,
        description: 'Active surveillance cameras in the downtown block. Triggering them marks your position for ARC patrols.',
    ...
    },
    {
        ...
        x: 33,
        y: 48,
        description: 'Narrow alley blanketed with broken glass and rubble — unavoidably loud without crouching slowly.',
    ...
    // ── Nature / environmental ────────────────────────────────────────────────
    {
        ...
        x: 42,
        y: 44,
        description: 'Reclaimed courtyard choked with vines and root systems. Dense cover — good for repositioning quietly between buildings.',
        tags: ['nature', 'cover'],
    },
    {
        ...
        x: 57,
        y: 27,
        description: 'Collapsed greenhouse on a commercial rooftop — thick plant growth provides concealment from above.',
    ...
    },
    {
        ...
        x: 50,
        y: 53,
        description: 'Mature trees lining the central plaza edge. Natural cover in an otherwise open sightline — but also a common camper spot.',
    ...
    },
    {
        ...
        x: 20,
        y: 72,
        description: 'Collapsed buildings reclaimed by heavy vegetation on the southwest edge. Dense foliage slows movement but offers concealment approaching the ruins extract.',
