            ...
            <div className="mx-auto max-w-7xl px-6 py-12">
                <div className="flex flex-col gap-10 md:flex-row md:justify-between">
                    ...
                    <div className="flex flex-col gap-4 max-w-xs">
                        ...
                        {/* Social icons — from Stellar footer */}
                    ...
                    <div className="flex flex-col gap-3">
                        <h4 className="text-xs uppercase tracking-widest text-rf-textSoft font-semibold">Tools</h4>
                ...
                {/* Data attribution */}
                <div className="mt-8 pt-5 border-t border-rf-border/50 text-[11px] text-white/20 space-y-1">
                    <p>
                        ...
                        {' '}and{' '}
                        <a href="https://ardb.app" target="_blank" rel="noopener noreferrer" className="hover:text-white/40 transition-colors">
                            ardb.app
                        </a>
